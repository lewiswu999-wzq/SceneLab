  ...
  return (
    <Card className="overflow-hidden rounded-lg border border-white/10 bg-white/[0.025] ring-0">
      <div className="aspect-video bg-zinc-900">
        ...
        <img src={poster.imageUrl} alt={poster.posterType} className="h-full w-full object-cover" />
      </div>
      <CardContent className="grid gap-3 p-4">
        <div className="flex items-center justify-between gap-3">
          <div className="text-sm font-medium text-zinc-100">{poster.posterType}</div>
